...
BLOG_AUTHOR = "Luis Campos"  # (translatable)
BLOG_TITLE = "Pensamientos de unluismas"  # (translatable)
...
BLOG_EMAIL = "luis.25.cames@gmail.com"
BLOG_DESCRIPTION = "Un blog para contener algunas ideas."  # (translatable)
